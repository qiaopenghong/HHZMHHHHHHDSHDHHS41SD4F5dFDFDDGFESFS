...
import com.hhzmy.main.com.hhzmy.bean.MyBean;
...
public class MyRecyclerLineAdapter extends RecyclerView.Adapter<MyRecyclerLineAdapter.MyHolder> {
    ...
    @Override
    public MyRecyclerLineAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final MyRecyclerLineAdapter.MyHolder holder, int position) {
